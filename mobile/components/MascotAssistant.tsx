...
const assistantDictionaries: Record<AssistantLanguageCode, AssistantDictionary> = {
  en: {
    ...
    messages: {
      ...
      '/(tabs)': 'This is Home. Review your mood prompt, choose Emotional Healing or Coaching, book a discovery session, or open your upcoming session.',
      ...
      '/topics': 'This topic page explains the focus area. Use the heart to save it, review coach options, or book a discovery session.',

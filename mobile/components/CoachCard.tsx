  ...
  return (
    <TouchableOpacity onPress={onPress} activeOpacity={0.85} style={styles.card}>
      ...
      <View style={styles.info}>
        <Text style={styles.name}>{coach.user.name}</Text>
        <Text style={styles.specialty}>{coach.specialty} · {coach.yearsExp} yrs</Text>
        <View style={styles.meta}>
          <Text style={styles.star}>★</Text>
          <Text style={styles.metaText}>{coach.rating.toFixed(1)}</Text>
          <View style={styles.dot} />
          <Text style={styles.metaText}>{coach.languages.join(' · ')}</Text>
        </View>
      </View>

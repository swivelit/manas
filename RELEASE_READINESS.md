...
- **Play Console advertising declarations**: before release, keep Contains ads and Advertising ID set to Yes and update Data safety for the Android build. Older active artifacts without `com.google.android.gms.permission.AD_ID` can still trigger the Advertising ID error even after a corrected AAB is uploaded.
